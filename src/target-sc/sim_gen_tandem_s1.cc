...
void IlaSim::create_rtl_class_header_s1(std::stringstream& rtl_wrapper, std::string& indent) {
...
void IlaSim::create_rtl_class_s1(std::stringstream& rtl_wrapper, std::string& indent) {
