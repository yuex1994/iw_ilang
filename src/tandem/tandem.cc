...
namespace ilang {
  ...
  void TandemGenerator::generate() {
    ...
    chmox(export_dir_.c_str(), 0x644))
    mkdir((export_dir_ + "include/").c_str(), 0x644);
    chmod((export_dir_ + "include/").c_str(), 0x644);
    mkdir((export_dir_ + "src/").c_str(), 0x644);
    chmod((export_dir_ + "src/").c_str(), 0x644);
    mkdir((export_dir_ + "src/ilated/").c_str(), 0x644);
    chmod((export_dir_ + "src/ilated/").c_str(), 0x644);
    mkdir((export_dir_ + "src/tandem/").c_str(), 0x644);
    chmod((export_dir_ + "src/tandem/").c_str(), 0x644);
